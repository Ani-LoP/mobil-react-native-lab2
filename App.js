    ...
    return (
        <NavigationContainer>
            <Drawer.Navigator initialRouteName="Home" useLegacyImplementation={true}>
                ...
                <Drawer.Screen name="Корзина" component={Basket}/>
                <Drawer.Screen name="Популярное" component={Popular} initialParams={good}/>
                <Drawer.Screen name="Смартфоны" component={Smartphones} />
                <Drawer.Screen name="Ноутбуки" component={Laptops} />
                <Drawer.Screen name="О нас" component={AboutAs} />
                <Drawer.Screen name="Тест" component={Test} />
            </Drawer.Navigator>
        </NavigationContainer>
    );
}